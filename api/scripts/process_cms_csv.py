...
# Top 100+ drugs to process (most prescribed in Medicare Part D)
TOP_DRUGS = [
    # Top 20 - Cardiovascular & Diabetes
    'ATORVASTATIN', 'LEVOTHYROXINE', 'LISINOPRIL', 'METFORMIN', 'AMLODIPINE',
    'SIMVASTATIN', 'LOSARTAN', 'METOPROLOL', 'ROSUVASTATIN', 'PRAVASTATIN',
    'FUROSEMIDE', 'CARVEDILOL', 'HYDROCHLOROTHIAZIDE', 'VALSARTAN', 'ENALAPRIL',
    'GLIPIZIDE', 'DILTIAZEM', 'SPIRONOLACTONE', 'CLOPIDOGREL', 'WARFARIN',
    
    # 21-40 - GI, Pain & CNS
    'OMEPRAZOLE', 'PANTOPRAZOLE', 'ESOMEPRAZOLE', 'LANSOPRAZOLE', 'RANITIDINE',
    'GABAPENTIN', 'PREGABALIN', 'TRAMADOL', 'MELOXICAM', 'IBUPROFEN',
    'ACETAMINOPHEN', 'NAPROXEN', 'CYCLOBENZAPRINE', 'METHOCARBAMOL', 'BACLOFEN',
    'SERTRALINE', 'ESCITALOPRAM', 'CITALOPRAM', 'DULOXETINE', 'FLUOXETINE',
    
    # 41-60 - Respiratory, Antibiotics & More
    'ALBUTEROL', 'FLUTICASONE', 'MONTELUKAST', 'BUDESONIDE', 'TIOTROPIUM',
    'AZITHROMYCIN', 'AMOXICILLIN', 'DOXYCYCLINE', 'CIPROFLOXACIN', 'LEVOFLOXACIN',
    'PREDNISONE', 'METHYLPREDNISOLONE', 'INSULIN GLARGINE', 'INSULIN ASPART', 'JANUVIA',
    'POTASSIUM CHLORIDE', 'VITAMIN D', 'FOLIC ACID', 'CALCIUM', 'ASPIRIN',
    
    # 61-80 - Mental Health & Sleep
    'TRAZODONE', 'MIRTAZAPINE', 'BUPROPION', 'VENLAFAXINE', 'PAROXETINE',
    'ALPRAZOLAM', 'LORAZEPAM', 'CLONAZEPAM', 'ZOLPIDEM', 'TEMAZEPAM',
    'QUETIAPINE', 'ARIPIPRAZOLE', 'RISPERIDONE', 'OLANZAPINE', 'CLONIDINE',
    'MEMANTINE', 'DONEPEZIL', 'RIVASTIGMINE', 'GALANTAMINE', 'LEVETIRACETAM',
    
    # 81-100 - Miscellaneous Common Drugs
    'TAMSULOSIN', 'FINASTERIDE', 'OXYBUTYNIN', 'TOLTERODINE', 'SOLIFENACIN',
    'CELECOXIB', 'DICLOFENAC', 'COLCHICINE', 'ALLOPURINOL', 'FEBUXOSTAT',
    'LATANOPROST', 'TIMOLOL', 'DORZOLAMIDE', 'BRIMONIDINE', 'TRAVOPROST',
    'ERGOCALCIFEROL', 'CHOLECALCIFEROL', 'TESTOSTERONE', 'ESTRADIOL', 'PROGESTERONE'
]
